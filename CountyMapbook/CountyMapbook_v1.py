...
def preparation():
    ...
    arcpy.Select_analysis(roads, database + "\\federalroads", "RTE_CLASS = '7' AND RTE_OPEN = 1 AND RDBD_TYPE = 'KG'")
    print "Copying grid..."
...
def pdf():
    ...
    dict2 = {}
    dict2["histmarkers"] = "Marker"
    #dict2["campgrounds"] = ""
    dict2["restareas"] = "Rest Area"
    dict2["parks"] = "Park"
    dict2["cemeteries"] = "Cemetery"
    dict2["cemeteries_point"] = "Cemetery"
    dict2["highways"] = "Highway"
    dict2["counties"] = "County"
    dict2["airports"] = "Airport"
    dict2["airports_point"] = "Airport"
    dict2["countyroads"] = "Street"
    dict2["prisons"] = "Prison"
    dict2["military"] = "Military Base"
    dict2["schools"] = "School"
    dict2["cities"] = "City"
    dict2["cities_point"] = "City"
    dict2["lakes"] = "Lake"
    dict2["railroads"] = "Railroad"
    dict2["rivers"] = "River"
    dict2["federalroads"] = "Roadway"
    #
    ...
    for fc in fcList:
        if fc.split("_")[-1] == "SUMMARIZED":
            ...
            f = frames.Frame(.8*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f2 = frames.Frame(2.725*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f3 = frames.Frame(4.65*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f4 = frames.Frame(6.575*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f5 = frames.Frame(8.5*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f6 = frames.Frame(10.425*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f7 = frames.Frame(12.35*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            f8 = frames.Frame(14.275*inch, .8*inch, 1.925*inch, 9.4*inch, bottomPadding=1)
            ...
            def thecanvas(c, doc):
                ...
                c.drawCentredString(width/2,height - .7*inch, feature.upper())
