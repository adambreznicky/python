...
output = "C:\\TxDOT\\County Road Inventory Mapbooks\\QC_20140203 - Copy" #+ suffixDate
...
def formatData():
    ...
    #this a variable added for QC purposes to utilize the current txdot roadways instead of the recent
    # quarterly published version. it is a temporary placeholder
    ...
    desc = arcpy.Describe(inventory2)
